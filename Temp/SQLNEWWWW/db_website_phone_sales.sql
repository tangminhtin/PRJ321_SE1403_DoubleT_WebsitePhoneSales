...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 22, 2020 lúc 08:49 AM
...
CREATE TABLE `customer` (
  ...
  `customerImage` varchar(500) NOT NULL,
...
(1, 'Nguyen Vu Khang', 'Soc Trang', '0348432564', 'huaquocvinh@gmail.com', './img/imageKhang.jpeg', 3),
(2, 'Truong Nhat Nam', 'Vinh Long', '0684567813', 'truongnhatnam@gmail.com', './img/Nam.jpg', 4),
(3, 'Nguyen Ngoc Anh Tu', 'An Giang', '0457894658', 'nguyenngocanhtu@gmai.com', './img/Tu.jpg', 5),
(4, 'Nguyen Tran Quang Hien', 'Dong Thap', '03632549558', 'hienqt@gmail.com', './img/Hien.jpg', 6),
(5, 'Bach Nguyen Phuc Thinh', 'Hau Giang', '123654789', 'phucthinh@gmail.com', './img/Hien.jpg', 16),
(6, 'Truong Nhat Thanh Fall', 'Vinh Long', '0123654789', 'Nams@gmail.com', 'img/users\\LOGOWEB.png', 17);
...
(3, 'Thinh Helo', 'HG', '0321456987', 'thinh@gmail.com', '', 12),
(4, 'Truong Thi Thanh Nhat', 'VL', '23654789', 'trondoibenem@gmail.com', '', 13);
...
(4, NULL, 6, 7019.46, 'Mua cho ghe', NULL, 5),
(5, NULL, 8, 12479.6, '', NULL, 6);
...
CREATE TABLE `phonedetail` (
  ...
  `phoneDetailVideo` varchar(300) DEFAULT NULL,
...
(1, 'tangminhtin', 'e10adc3949ba59abbe56e057f20f883e', 'admin'),
(2, 'bachnguyenphucthinh', 'e10adc3949ba59abbe56e057f20f883e', 'staff'),
(3, 'huaquocvinh', 'e10adc3949ba59abbe56e057f20f883e', 'customer'),
(4, 'truongnhatnam', 'e10adc3949ba59abbe56e057f20f883e', 'customer'),
(5, 'nguyenngocanhtu', 'e10adc3949ba59abbe56e057f20f883e', 'customer'),
(6, 'huynhthinhien', 'e10adc3949ba59abbe56e057f20f883e', 'staff'),
...
(12, 'thinh123', 'e10adc3949ba59abbe56e057f20f883e', 'staff'),
(13, 'namluvXuan', 'e10adc3949ba59abbe56e057f20f883e', 'staff'),
(16, 'phucthinhbach123', 'e10adc3949ba59abbe56e057f20f883e', 'customer'),
(17, 'namyeuSpring', 'e10adc3949ba59abbe56e057f20f883e', 'customer');
...
--
ALTER TABLE `addcart`
  MODIFY `addCartId` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `addcart`
--
ALTER TABLE `addcart`
  ADD CONSTRAINT `addcart_ibfk_1` FOREIGN KEY (`phoneId`) REFERENCES `phone` (`phoneId`),
  ADD CONSTRAINT `addcart_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);
