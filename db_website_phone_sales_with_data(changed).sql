...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 27, 2020 lúc 06:38 PM
...
INSERT INTO `brand` (`branchId`, `branchName`, `branchImage`) VALUES
(1, 'Apple', NULL),
(2, 'Samsung', NULL),
(3, 'Google', NULL);
...
--
ALTER TABLE `phone`
  ADD CONSTRAINT `phone_ibfk_1` FOREIGN KEY (`brandId`) REFERENCES `brand` (`branchId`),
