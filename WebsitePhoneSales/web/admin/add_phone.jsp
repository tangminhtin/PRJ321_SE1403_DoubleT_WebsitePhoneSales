                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="../PhoneController?query=add" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="txtPhonePrice" type="number" step="0.01" min="0" class="form-control" id="phonePrice" placeholder="$998">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="txtPhoneDiscount" type="number" step="0.01" min="0" class="form-control" id="phoneDiscount" placeholder="$30">
                                                    </div>
                                                </div>
